...
def generate_SM_calibrated_UQ(data):
    """
    ...
    >>> uq = generate_SM_calibrated_UQ(data)
    >>> 
    >>> # Use with calibrated estimates
    >>> calibrated_sm = calibrated_values['SM_cal']
    ...
    return pd.Series(uq, index=data.index, name='SM_calibrated_UQ')
