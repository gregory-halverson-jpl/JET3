...
def generate_RH_calibrated_UQ(data):
    """
    ...
    >>> uq = generate_RH_calibrated_UQ(data)
    >>> 
    >>> # Use with calibrated estimates
    >>> calibrated_rh = calibrated_values['RH_cal']
    ...
    return pd.Series(uq, index=data.index, name='RH_calibrated_UQ')
